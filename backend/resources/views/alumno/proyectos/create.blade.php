...
<div class="container mt-4">
    ...
    <form action="{{ route('alumno.proyectos.store') }}" method="POST">
        @csrf
        ...
        <div class="mb-3">
            ...
            <textarea name="alumnos"
                      class="form-control"
                      rows="3"
                      placeholder="Ej: Nombre1 Apellido1, Nombre2 Apellido2..."
                      required>{{ old('alumnos') }}</textarea>
        </div>

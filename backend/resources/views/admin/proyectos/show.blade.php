...
<div class="container details">
    <article class="card details-card mt-5" id="details-form-container">
        ...
        {{-- Observaciones --}}
        @if($proyecto->observaciones && $proyecto->observaciones !== 'null')
        <section class="section">
        ...
        <section class="section">
            ...
            <textarea
                ...
                style="width:100%; background-color:#E4EEF7; border:var(--border-default); border-radius:var(--radius-sm); padding:8px 10px; font-family:var(--font-body); font-size:var(--font-size-base); resize:vertical;">{{ old('observaciones') }}</textarea>
        </section>
        <hr class="divider" />
        @endif
